...
const setStatusAsAuthor = (people) => { people.forEach((element,index) => people[index].isAuthor = true);
  // Solution code here...
};
...
const append = (arr1, arr2) => { arr1.forEach((element,index) => arr1.push(arr2[index]));};
